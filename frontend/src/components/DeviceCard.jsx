import { Fan, Lightbulb, Thermometer, Droplets, HelpCircle } from "lucide-react";
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-center gap-2 mt-2">
            <div className={`w-2 h-2 rounded-full ${
              isOn ? "bg-emerald-300 animate-pulse" : "bg-slate-300"
            }`}></div>
            <span className={`text-sm font-medium ${
              isOn ? "text-indigo-100" : "text-slate-500"
            }`}>
